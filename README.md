...
```sh
brew install debuging-life/tap/deskgit          # tagged release (once one exists)
...
companion `dt-hook`. See the [deskgit README](https://github.com/debuging-life/lazygit/blob/dtgit/README.md).
